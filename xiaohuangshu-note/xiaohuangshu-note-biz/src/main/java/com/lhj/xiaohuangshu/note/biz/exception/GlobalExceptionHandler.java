package com.lhj.xiaohuangshu.note.biz.exception;
...
public class GlobalExceptionHandler {
    ...
    //获取校验不通过的字段，并组合错误信息，格式为：email 邮件格式不正确，当前值：‘123456qq.com’
    ...
    log.warn("{} request fail, errorCode: {}", request.getRequestURI(), errorCode);
