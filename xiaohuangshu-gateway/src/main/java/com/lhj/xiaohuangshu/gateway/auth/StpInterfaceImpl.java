...
import com.lhj.xiaohuangshu.gateway.constant.RedisKeyConstants;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getRoleList(Object loginId, String loginType){
       ...
       //根据用户ID, 从Redis中获取该角色的角色集合
        Object userRolesValue = redisTemplate.opsForValue().get(userRolesKey);
        String useRolesValue = userRolesValue == null ? null : userRolesValue.toString();
