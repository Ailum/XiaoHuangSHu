package com.lhj.xiaohuangshu.oss.biz.strategy.impl;

import com.aliyun.oss.OSS;
import com.lhj.xiaohuangshu.oss.biz.config.AliyunOSSProperties;
...
public class AliyunOSSFileStrategy implements FileStrategy {
    ...
    public String uploadFile(MultipartFile file, String bucketName) {
        ...
        //返回文件的访问链接
        String url = String.format("http://%s.%s/%s",bucketName,aliyunOSSProperties.getEndpoint(),objectName);
